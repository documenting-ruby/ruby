 ...
 *   => OpenSSL::HMAC
 *
 * Note that two instances won't be equal when they're compared, even if
 * they have the same value. Use #to_s or #hexdigest to return the
 * authentication code that the instance represents.
 *
 * === Example
